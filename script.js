...
background, fill, ellipse, rect, random, noStroke*/

var GameOn, lives, score, yPos_red;
var line1_x, line1_y, line1_length;
var line2_x, line2_y, line2_length;
(ine1_x = line1_x - decreaseLength_line1), decreaseLength_line2;
...
function draw() {
  if (GameOn == true) {
    ...
    if (line2_x < 0 - line1_length) {
      line2_x = 400;
      line2_y = random(100, 350);
      line2_length = random(100, 320);
      decreaseLength_line2 += 0.5;
      lives--; //lives= lives-1; equal to lives-=1;
    }

    if (line1_y < yPos_red + 15 && line1_y > yPos_red - 15) {
      if (line1_x < 115 && line1_length > 85) {
        line1_x = 400;
        score++;
        line1_y = random(100, 350);
        line1_length = random(20, 320);
    ...
    if (line2_y < yPos_red + 15 && line2_y > yPos_red - 15) {
      if (line2_x < 115 && line2_length > 85) {
        line2_x = 400;
        score++;
        line2_y = random(100, 350);
        line2_length = random(20, 320);
    ...
    //rect(x top L, y top L, width,length, curve corner)
    fill(250, 223, 150);
